<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-700 leading-tight">
            ...
            Edit Biaya Audit Provinsi {{ $province->name }}
        </h2>
    </x-slot>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('pengaturan-biaya-audit.update', $province->id) }}" method="POST">
                        ...
                        <h3 class="text-lg font-semibold mb-4">Biaya Dalam Kota</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="mb-4">
                                <label for="transport_dalam_kota" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Transport Dalam Kota (Rp)</label>
                            ...
                            <div class="mb-4">
                                <label for="uhpd_dalam_kota" class="block text-sm font-medium text-gray-700 dark:text-gray-300">UHPD Dalam Kota (Rp)</label>
                                {{-- Ganti $konfigurasiBiaya menjadi $province --}}
                        ...
                        <h3 class="text-lg font-semibold mb-4">Biaya Luar Kota / Antar Provinsi</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="mb-4">
                                <label for="hotel_luar_kota" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Hotel Luar Kota (Rp)</label>
                                {{-- Ganti $konfigurasiBiaya menjadi $province --}}
                            ...
                            <div class="mb-4">
                                <label for="transport_luar_kota" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Transport Luar Kota (Rp)</label>
                                {{-- Ganti $konfigurasiBiaya menjadi $province --}}
                            ...
                            <div class="mb-4">
                                <label for="tiket_pesawat_luar_kota" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Tiket Pesawat Luar Kota (Rp)</label>
                                {{-- Ganti $konfigurasiBiaya menjadi $province --}}
                            ...
                            <div class="mb-4">
                                <label for="uhpd_luar_kota" class="block text-sm font-medium text-gray-700 dark:text-gray-300">UHPD Luar Kota (Rp)</label>
                                {{-- Ganti $konfigurasiBiaya menjadi $province --}}
