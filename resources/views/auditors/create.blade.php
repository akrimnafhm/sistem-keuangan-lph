            ...
            <div class="p-6 border rounded-lg dark:border-gray-300 bg-gray-50 shadow-lg">
                <form action="{{ route('auditors.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama" value="{{ old('nama') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm bg-white text-gray-500 dark:text-gray-700 focus:ring-gray-400" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm bg-white text-gray-500 dark:text-gray-700 focus:ring-gray-400" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nomor_aktif" value="{{ old('nomor_aktif') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm bg-white text-gray-500 dark:text-gray-700 focus:ring-gray-400" required>
                        <x-input-error :messages="$errors->get('nomor_aktif')" class="mt-2" />
                    </div>
