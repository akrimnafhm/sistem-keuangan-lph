                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="mb-6 p-4 border rounded-lg dark:border-gray-700">
                        ...
                        <div>
                            ...
                            <p class="mt-1 block w-full md:w-1/3 px-3 py-2 border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 rounded-md shadow-sm">
                    ...
                    <div class="mb-6 p-4 border rounded-lg dark:border-gray-700">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Mikro & Kecil</label>
                                <p class="mt-1 block w-full px-3 py-2 border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 rounded-md shadow-sm">
                                    Rp {{ number_format($konfigurasi->fee_uin_mikro, 0, ',', '.') }}
                                </p>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Menengah</label>
                                <p class="mt-1 block w-full px-3 py-2 border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 rounded-md shadow-sm">
                                    Rp {{ number_format($konfigurasi->fee_uin_menengah, 0, ',', '.') }}
                                </p>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Besar</label>
                                <p class="mt-1 block w-full px-3 py-2 border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 rounded-md shadow-sm">
