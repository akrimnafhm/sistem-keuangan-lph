                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('pelaku-usaha.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="city_id" id="city-dropdown" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 rounded-md shadow-sm" required disabled>
